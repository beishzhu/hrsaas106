<template>
  <div class="dashboard-container">
    ...
    <!-- 离职申请对话框 -->
    <el-dialog title="离职申请" :visible.sync="showDialog" @close="btnCancel">
      <el-form label-width="110px" :model="ruleForm" :rules="rules" ref="ruleForm">
        <el-form-item label="离职时间" prop="exceptTime">
          <el-date-picker type="datetime" v-model="ruleForm.exceptTime" value-format="yyyy-MM-dd HH:mm:ss" placeholder="选择日期时间"></el-date-picker>
        </el-form-item>
